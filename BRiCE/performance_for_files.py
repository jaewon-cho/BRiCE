#!/usr/bin/env python
# coding: utf-8
#usage: ./performance_for_files.py folder_name index 

#folder_name 
#index: yes (include singlets) or no (only multiplets) for Response effect size
# manuscript: we used "no"


import sys, os
import pandas as pd
sys.path.append("path to performance.py")
