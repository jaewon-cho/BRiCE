#!/usr/bin/env python
# coding: utf-8
#response classification: entropy_process
#usage: result = entropy_process(your_object, "expand", latent = None)
#latent: use_rep for sc.pp.neighbors
#latent should be specified if needed

#response effect size: clonality_correlation
#usage: result = clonality_correlation(your_object, k=5, latent = None)
#latent: use_rep for sc.pp.neighbors
#latent should be specified if needed
...
def entropy_process(latent_obj, category, latent = None):
