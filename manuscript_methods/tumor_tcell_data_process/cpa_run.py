...
# In[13]:
#usage: cpa_run.py sample_list_file data_name data_root_dir var_name save_root_dir
#sample_file_list:
#data_name: gse236581
...
def CPA_process(pat):
    ...
    latent_basal_entropy = entropy_process(latent_outputs['latent_basal'], "Tissue")
    latent_after_entropy = entropy_process(latent_outputs['latent_after'], "Tissue")
    new_obj = latent_outputs['latent_after']
    new_obj1 = new_obj[new_obj.obs["Tissue"] == "Tumor"]
