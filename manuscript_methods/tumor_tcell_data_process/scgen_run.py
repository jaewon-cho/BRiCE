...
def scgen_process(pat):
    ...
    scgen.SCGEN.setup_anndata(adata, batch_key="Tissue")
    ...
    latent_after_entropy = entropy_process(latent_adata,'Tissue')
    
    new_obj1 = latent_adata[latent_adata.obs["Tissue"] == "Tumor"]
