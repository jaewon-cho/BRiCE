#!/usr/bin/env python
# coding: utf-8
#usage: ./common_perturb_only.py data_name data_name_extra data_root_dir var_name 
#data_name: gse236581
...
if not os.path.exists(data_dir + "perturb_only/" + var_name):
    os.makedirs(data_dir + "perturb_only/" + var_name)
os.chdir(data_dir + "perturb_only/" + var_name)
...
for pat in pat_list:
    print(pat)
    adata1 = adata[(adata.obs["individual"] == pat) & (adata.obs["condition"] == "perturb")]
